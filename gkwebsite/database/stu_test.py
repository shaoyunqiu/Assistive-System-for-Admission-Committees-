...
def testCreateStudent():
    ...
    return True
def testGetStudent():
    getStudent('lihy2',Student.REAL_NAME)
    getStudent('lihy2', Student.BIRTH)
    getStudent('lihy123', Student.BIRTH)
    getStudent('lihy123', 'a')

def testSetStudent():
    setStudent('lihy2',Student.REAL_NAME,u'李昊阳')
    getStudent('lihy2', Student.REAL_NAME)
    setStudent('lihy2', Student.BIRTH, datetime.datetime(1996, 4, 5))
    getStudent('lihy2', Student.BIRTH)

def testTranStudent():
    idToAccountStudent(getStudent('lihy2',Student.ID))
    accountToIDStudent('lihy2')
